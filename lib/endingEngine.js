...
export function calculateEndingScore(stats) {
  // Hope + Humanity = constructive forces
  // Chaos + low Trust = destructive
  const constructive = (stats.hope + stats.humanity) / 2;
  const destructive = (stats.chaos * 0.7) + ((100 - stats.trust) * 0.3);
