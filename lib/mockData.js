...
export const AVATARS = [
  {
    ...
    "backstory": "Before everything collapsed, you mapped trails for search-and-rescue teams in the mountains — a job that rewarded patience and punished assumptions. The instinct to read a landscape, to notice what's out of place, kept you alive when most weren't. You move through the ruins like someone who already knows what's around the corner, because you've learned to look.",
  ...
  },
  {
    ...
    "backstory": "You were a third-year resident when the hospitals stopped functioning — not all at once, but in stages, like a long exhale. You learned to work with less, then with almost nothing, then with whatever you could find. The people you couldn't save taught you something you're still carrying: that doing everything right doesn't always mean enough.",
  ...
  },
  {
    ...
    "backstory": "You kept municipal water and power running for a mid-sized city — unglamorous work, invisible until something broke. When the grid finally went dark for good, you understood the collapse not as an event but as a series of cascading failures, each one predictable in hindsight. Now you measure survival in pumps that prime, wires that hold, and walls that don't come down. The world runs on the things people forget to thank.",
  ...
  },
  {
    ...
    "backstory": "You spent years as a corrections officer, then a shelter coordinator — both jobs that taught you the weight of standing at a door deciding who comes in. You've seen what fear does to people, how quickly a crowd becomes a threat and a threat becomes a tragedy. You carry that knowledge like a loaded thing: the understanding that protection and cruelty often wear the same uniform, and only your choices tell them apart.",
  ...
  },
  {
    ...
    "backstory": "You negotiated labor disputes and community land deals — work that lived in the space between people who refused to be in the same room. You learned that everyone has a reason, that the loudest demand is rarely the real one, and that trust, once broken, costs ten times more to rebuild. In a world fractured into wary camps, you're betting that words can still hold what walls cannot.",
  ...
  },
  {
    ...
    "backstory": "You grew up trading in flea markets and salvage yards, with an eye for the worth others walked past. When the supply chains died, that eye became a lifeline — you can read a ruin like a ledger, knowing what's still good, what's worth the risk, what to leave behind. The hard part was never finding things. It was deciding who gets them, and what you're willing to become to keep your crew fed.",
