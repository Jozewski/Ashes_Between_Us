...
import { getAvatarFallbackChoices } from "./avatarWritingGuide.js";
...
function localFallbackScenario({
  ...
  return {
    ...
    choices: [
      ...getAvatarFallbackChoices(avatar.id),
      {
      ...
      {
        text: "Use the convoy dispute to secure private leverage.",
        outcome:
          "Your people gain priority passage. Everyone else sees the shape of the bargain and files it away for later.",
        hopeChange: 3,
        trustChange: -6,
        chaosChange: 1,
        humanityChange: -5,
      ...
      {
        text: "Delay departure until every faction names its price.",
        outcome:
          "The argument becomes honest, then dangerous. Hidden demands surface while the safest hour for travel slips away.",
        hopeChange: -2,
        trustChange: 5,
        chaosChange: 3,
        humanityChange: 1,
